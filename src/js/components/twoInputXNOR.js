...
$("#select2InputXNOR").click(function() {
    ...
    var twoInputXNOR = new Vue({
        ...
        '<path style="stroke-width:2.59566951" d="m 94.833332,32.499999 c 16.333338,0 20.416668,0 20.416668,0" ondblclick="findOutputCoords(this.parentNode.parentNode)" class="gate-output"/>'+
        '<path style="stroke-width:2.59566903" d="m 36.097503,18.749999 -31.0975032,0" aria-label="18.749999" ondblclick="findInputCoords(this)" class="gate-input"/>'+
        '<path style="stroke-width:2.59566903" d="m 37.293562,46.249997 -32.2935622,0" aria-label="46.249997" ondblclick="findInputCoords(this)" class="gate-input"/>'+
