...
$("#select3InputAND").click(function() {
    ...
    var threeInputAND = new Vue({
        ...
        '<path d="m 74.98,25.13 c 16.01,0 20.02,0 20.02,0" class="gate-output" onclick="findOutputCoords(this.parentNode.parentNode)" style="stroke-width:1.78999996"></path>'+
    ...
    new ThreeInputAND(uniqueID, false, false, false);
