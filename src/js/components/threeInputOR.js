...
$("#select3InputOR").click(function() {
    ...
    var threeInputOR = new Vue({
        ...
        '<path d="m 81.784691,27.513008 c 21.845749,0 27.307189,0 27.307189,0" class="gate-output" ondblclick="findOutputCoords(this.parentNode)" style="stroke-width:2.45161653" />'+
        '<path d="m 28.858524,9.9685914 -28.66912837,0" aria-label="9.9685914" class="gate-input" ondblclick="findInputCoords(this)" style="stroke-width:2.46322799" />'+
        '<path d="m 29.841671,44.868029 -30.03106663,0" aria-label="44.868029" class="gate-input" ondblclick="findInputCoords(this)" style="stroke-width:2.4739306" />'+
        ...
        '</g>'+
        '</g>'+
        '<path d="m 30.941876,27.563661 -31.13127168,0" aria-label="27.563661" class="gate-input" ondblclick="findInputCoords(this)" style="stroke-width:2.56682229" />'+
        '</svg>'
    });
