...
var twoInputNAND = new Vue({
    el: '.insertion-point',
    template: '<svg xmlns="http://www.w3.org/2000/svg" width="110.25" height="55" class="two-input-NAND" version="1.0">'+
    '<g transform="translate(-5,-5)">'+
    '<path style="stroke-width:2.59566951" d="m 95.65,32.5 c 15.68,0 19.6,0 19.6,0" class="gate-output"/>'+
    '<path style="stroke-width:2.59566951" d="M 36.85,18.75 5,18.75" class="gate-input"/>'+
    '<path style="stroke-width:2.59566951" d="M 38.075,46.25 5,46.25" class="gate-input"/>'+
