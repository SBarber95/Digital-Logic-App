...
$("#select2InputAND").click(function() {
    ...
    var twoInputAND = new Vue({
        ...
        '<path d="m 74.98,25.13 c 16.01,0 20.02,0 20.02,0" ondblclick="findOutputCoords(this.parentNode.parentNode)" class="gate-output"></path>'+
        '<path d="m 31,16.150564 -20.89,0" aria-label="16.150564" ondblclick="findInputCoords(this)" class="gate-input"></path>'+
        '<path d="m 32,34.140661 -22.02,0" aria-label="34.140661" ondblclick="findInputCoords(this)" class="gate-input"></path>'+
