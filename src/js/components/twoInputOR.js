...
$("#select2InputOR").click(function() {
    ...
    var twoInputOR = new Vue({
        ...
        '<path style="stroke-width:2.45161653" d="m 91.734439,32.513008 c 21.845751,0 27.307191,0 27.307191,0" class="gate-output"/>'+
        '<path style="stroke-width:2.46322799" d="m 38.618876,18.756504 -28.6691285,0" class="gate-input"/>'+
        '<path style="stroke-width:2.4739306" d="m 39.980814,46.269512 -30.0310665,0" class="gate-input"/>'+
    ...
    new TwoInputOR(uniqueID, false, false);
