...
$("#select3InputNOR").click(function() {
    ...
    var threeInputNOR = new Vue({
        ...
        '<path style="stroke-width:2.58471894" d="m 95.13382,32.424619 c 24.36049,0 19.48839,0 19.48839,0" ondblclick="findOutputCoords(this.parentNode.parentNode)" class="gate-output"/>'+
        '<path style="stroke-width:2.51228857" d="m 35.168639,15.46231 -29.918639,0" aria-label="15.46231" ondblclick="findInputCoords(this)" class="gate-input"/>'+
        '<path style="stroke-width:2.48453379" d="M 35.386664,50.136929 5,50.136929" aria-label="50.136929"  ondblclick="findInputCoords(this)" class="gate-input"/>'+
        ...
        '</g>'+
        '</g>'+
        '<path style="stroke-width:2.63523626" d="m 37.918639,32.71231 -32.9186389,0" aria-label="32.71231" ondblclick="findInputCoords(this)" class="gate-input"/>'+
        '</g>'+
        '</svg>'
    });
