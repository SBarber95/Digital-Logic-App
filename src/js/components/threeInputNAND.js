...
$("#select3InputNAND").click(function() {
    ...
    var threeInputNAND = new Vue({
        ...
        '<path style="stroke-width:2.59566951" d="m 95.65,32.5 c 15.68,0 19.6,0 19.6,0" class="gate-output" ondblclick="findOutputCoords(this.parentNode.parentNode)"/>'+
        '<path style="stroke-width:2.59566951" d="m 36.85,14.860913 -31.85,0" aria-label="14.860913" ondblclick="findInputCoords(this)" class="gate-input"/>'+
        '<path style="stroke-width:2.59566927" d="m 38.075,49.962311 -33.075,0" aria-label="49.962311" ondblclick="findInputCoords(this)" class="gate-input"/>'+
        ...
        '<path style="stroke-width:2.59566951" d="m 36.799748,32.486544 -31.8500005,0" aria-label="32.486544" ondblclick="findInputCoords(this)" class="gate-input"/>'+
        '</g>'+
        '</svg>'
    });
