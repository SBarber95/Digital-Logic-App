    ...
    <div>
        <div class="container-fluid">
            <div class="row">
                ...
                <button id="delete_circuit" style="position: relative; left: 74%; top: 70px;"
                        class="btn btn-danger">Delete Circuit
                </button>
                <button id="simulate" @click="simulate"
                        style="position: relative; left: 63%; top: 130px;" class="btn btn-primary">Simulate
                </button>
            </div>
        </div>
...
<script>
    ...
    import $ from 'jquery'
    import circuitDesignMixin from "../mixins/circuitDesignMixin";
