    ...
    <svg xmlns="http://www.w3.org/2000/svg"
        ...
        <g transform="matrix(1.234375,0,0,1.3732704,-12.158594,-6.866352)" class="component">
            <path
                    ...
                    class="gate-output"
                    aria-label="34.5"
                    style="fill:none;stroke-width:1.78999996;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1">
            </path>
            <path
                    d="m 31,16.150564 -20.89,0"
                    id="input-A2-AND"
                    aria-label="22.2"
            ...
            <path
                    d="m 32,34.140661 -22.02,0"
                    class="gate-input input2"
                    id="input-B2-AND"
                    aria-label="47"
                    style="fill:none;stroke-width:1.80999994;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1">
            </path>
            <path
            ...
            <rect x="30" y="6" width="43" height="43" fill="transparent" class="drag-box"/>
        </g>
    </svg>
</template>